		...
		<form class="form-inline" method="post" action="{ROW.action}">
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						<td><input type="hidden" name="report_id" value="{ROW.id}" /><input type="hidden" name="link" value="{ROW.link}" /><input class="btn btn-primary" type="submit" name="submit" value="{LANG.report_confirm}" style="text-align: center;"/></td>
					</tr>
				</table>
			</div>
		</form>
