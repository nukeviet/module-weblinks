...
// ID goi cap nhat
$nv_update_config['packageID'] = 'NVUDWLINKS4029';
...
$nv_update_config['support_website'] = 'https://github.com/nukeviet/module-weblinks/tree/4.0.29';
...
function nv_up_p1()
{
    ...
    foreach ($array_modlang_update as $lang => $array_mod) {
        foreach ($array_mod['mod'] as $module_info) {
            ...
            try {
                $db->query("ALTER TABLE " . $table_prefix . "_rows DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");
            } catch (PDOException $e) {
                trigger_error($e->getMessage());
            }
            try {
                $db->query("ALTER TABLE " . $table_prefix . "_cat DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");
            } catch (PDOException $e) {
                trigger_error($e->getMessage());
            }
            try {
            ...
            try {
                $db->query("ALTER TABLE " . $table_prefix . "_report DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");
            } catch (PDOException $e) {
                trigger_error($e->getMessage());
            }

            // Cập nhật chasert từng cột của các bảng
            $array_table = array('_rows', '_cat', '_config', '_report');
    ...
    try {
        ...
        if (!$num) {
            $db->query("INSERT INTO " . $db_config['prefix'] . "_setup_extensions (
                ...
                26, 'module', 'weblinks', 0, 1, 'weblinks', 'weblinks', '4.0.29 1463590800', " . NV_CURRENTTIME . ", 'VINADES.,JSC (contact@vinades.vn)', 
