            ...
            <div class="flex-bl">
                ...
                <div class="main">
                    <table class="table table-striped table-bordered">
                        <tbody>
                            <tr>
                                <td class="tableleft">{LANG.name}: <span class="mobile-inline-block"><a href="{ITEM.linkvi}" target="_blank" title="{ITEM.title}"><em class="fa fa-link margin-right-sm"></em>{ITEM.url}</a></span></td>
